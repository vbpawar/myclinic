    ...
    <body>
        <div class="wrapper">
            <div class="page-wrap">
                ...
                <button class="btn btn-danger" type="button" style="float: right;margin-bottom: 10px;" data-toggle="modal" data-target="#exerciseModal">Add New Exercise</button>
