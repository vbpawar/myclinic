...
function print_prscription(patientId, doctorId, visitDate) {
    $('<form action="prescription-print.php" method="GET" target="_blank"><input type="hidden" name="pflag" value="' + lang_flag + '" /><input type="hidden" name="ppatientId" value="' + patientId + '" /><input type="hidden" name="pdoctorId" value="' + doctorId + '" /><input type="hidden" name="pvisitDate" value="' + visitDate + '" /></form>').appendTo('body').submit();
